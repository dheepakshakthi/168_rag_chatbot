    ...
    chatContainer.innerHTML = `
        <div class="welcome-message">
            ...
            <div class="feature-grid">
                <div class="feature-item"><span class="feature-icon">📄</span><span>PDF Documents</span></div>
                <div class="feature-item"><span class="feature-icon">🌐</span><span>HTML Files</span></div>
                <div class="feature-item"><span class="feature-icon">💻</span><span>Code Files</span></div>
                <div class="feature-item"><span class="feature-icon">💬</span><span>General Chat</span></div>
            </div>
    ...
    try {
        ...
        if (data.success && data.files.length > 0) {
            ...
            data.files.forEach(file => {
                ...
                else if (['py', 'java', 'js', 'cpp', 'c', 'h', 'cs'].includes(ext)) icon = '💻';
